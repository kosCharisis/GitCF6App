...
public class ExParkingTestApp {
 ...
 //       }
       ...
       // int[] test = {1, 1, 0, 1, 1, 1, 0, 1, 0, 0, 0, 0};
        System.out.print(togetherParkedn(parked, 0));
    }
    ...
    /**
     * Checks the elements of an array for a key number
     * and returns the number of the repeated elements
     *
     * @param arr       the input array
    ...
    public static int togetherParked(int[] arr, int key) {
        ...
        together = highIndex - lowIndex + 1;
        return together;
    }

    public static int togetherParkedn(int[] arr, int key) {
        int largest = 0;
        int count = 0;
